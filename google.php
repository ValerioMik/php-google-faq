...
<body>
    ...
    <header>
        <div class="logo">
            <img class="dimensione" src="img/Google_2015_logo.svg.png" alt=""><a class="termini" href="">Privacy e Termini</a>
        </div>
        <div class="navigatore">
            <ul>
                ...
                <li>
                    <a class="cliccato" href=""> Domande frequenti</a>
                </li>
            </ul>
        </div>
    </header>
    ...
    <?php
        foreach ($googleArr as $key => $titoli) {
            echo '<div class="container"><h1>'. $key.'</h1>';
            foreach ($titoli as $value) { // stampa paragrafi
               echo "<p>".$value."</p>";
            }
            echo '</div>';
        }
